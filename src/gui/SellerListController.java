...
public class SellerListController implements Initializable, DataChangeListener{
	...
	public void obBtSearchAction(ActionEvent event) {
		...
		createDialogSearch(obj, "/gui/SellerSearch.fxml", parentStage);
	}
	...
	public void updateTableViewSearch(List<Seller> list) {
		if(service == null) {
			throw new IllegalStateException("Service was null");
		}
	...
	private void createDialogSearch(Seller obj, String absoluteName, Stage parentStage) {
		try {
			//load .fxml and save on Pane
			FXMLLoader loader = new FXMLLoader(getClass().getResource(absoluteName));
			Pane pane = loader.load();
			...
			//injection dependence
			SellerSearchController controller = loader.getController();
			controller.setSeller(obj);
			controller.setServices(new SellerService(), new DepartmentService());
			controller.loadAssociatedObjects();
